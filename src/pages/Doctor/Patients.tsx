...
const Tables: React.FC = () => {
  ...
  const fetchPatients = async () => {
    try {
      ...
      if (response.status === 200) {
        setPatients(response.data.category);
      } else {
  ...
  const handleAddPatient = (e: FormEvent) => {
    ...
    handleSubmit(url, formDataToSend, setPatientPopupOpen, 'Patient created successfully!',);
                  ...
                  <div className="bg-white lg:w-1/2 rounded-lg p-4 shadow-md">
                    <div className="flex flex-row justify-between">
                      ...
                      <div className="flex justify-end">
                        <button
                          onClick={() => closePopup(setPatientPopupOpen)}
